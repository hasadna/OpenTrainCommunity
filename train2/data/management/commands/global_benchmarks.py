...
class Command(BaseCommand):
    ...
    def compute_trips_per_day(self, day):
        ...
        print('Trips with some late station for day = {} % = {}'.format(day, 100-100.0*late_qs.count()/ok_qs.count()))
    ...
    def compute_trips_per_hour(self, hour):
        ...
        late_qs = ok_qs.filter(c__gte=300)
        print('Trips with some late station for hour = {} % = {}'.format(hour, 100-100.0*late_qs.count()/ok_qs.count()))
