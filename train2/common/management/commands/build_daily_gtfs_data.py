...
from ...slack_utils import send_error, send_info
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            send_info(f'build_daily_gtfs_commands ended successfully daily = {daily.shape}')
        except Exception as ex:
            logger.exception(ex)
            send_error(f'Failed in build_daily_gtfs_commands {ex}')
